...
export default class Pong extends Phaser.Scene
{
  ...
  create()
  {
	...
	this.score1_text = this.add.text(400, 250, '0', { fontFamily: "ibm-3270", fontSize: "128px" });
	this.score2_text = this.add.text(1200, 250, '0', { fontFamily: "ibm-3270", fontSize: "128px" });
  }
