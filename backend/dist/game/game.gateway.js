...
let GameGateway = class GameGateway {
    ...
    handleInvitePlay(client, ...args) {
        let intra = args[0].intra;
        let other_intra = args[0].other_intra;
        let player = new game_service_1.Player(client, intra, this.users);
        ...
        if (other_player != undefined) {
            ...
            let room = new game_service_1.Room(room_id, player, other_player);
    ...
    searchInviteArray(intra, other_intra) {
    ...
    async handleCreateOrJoinMode(client, data) {
        let searching_player = new game_service_1.Player(client, data[0], this.users, data[1]);
...
__decorate([
    (0, websockets_1.SubscribeMessage)("invitePlay"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Object]),
    __metadata("design:returntype", void 0)
], GameGateway.prototype, "handleInvitePlay", null);
__decorate([
    (0, websockets_1.SubscribeMessage)("createOrJoinMode"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [socket_io_1.Socket, Object]),
    __metadata("design:returntype", Promise)
], GameGateway.prototype, "handleCreateOrJoinMode", null);
__decorate([
